      ...
      <div>
        <div className="port_bigBox">
          ...
          <div className={styles.project}>
            <span className={styles.projectNames}>Pokemon Website</span>
          ...
          {/*  */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Image Slider</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/*  */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Toggle Pop Up</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/*  */}
          <div className={styles.project}>
            <span className={styles.projectNames}>To Do App</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/*  */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Form Validation</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/*  */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Weight Converter</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/* cricket */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Cricket API</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/* copy to clip */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Copy to Clipboard</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/* weather api */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Weather App</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/* theme changer */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Theme Change</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          {/* movie api */}
          <div className={styles.project}>
            <span className={styles.projectNames}>Movies API</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
          ...
          <div className={styles.project}>
            <span className={styles.projectNames}>Heroku Deployed App</span>
            <div className={styles.buttons}>
              <button className={styles.eachbutton}>
                <a
                  target="_blank"
              ...
              <button disabled="true" className={styles.eachbutton}>
